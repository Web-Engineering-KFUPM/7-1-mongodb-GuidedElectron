...
mongoose
  .connect("mongodb+srv://guided_electron:P0lsk@_0352@cluster0.lzcdown.mongodb.net/labDB")
//   mongodb+srv://guided_electron:<db_password>@cluster0.lzcdown.mongodb.net/
...
async function run() {
  try {
   ...
   //  await readStudents();     // optional: verify final result
  } catch (err) {
